    ...
    for resolution in [5000, 10000, 25000, 50000]:
        ...
        for TMP1 in ["1", "5", "10", "15"]:
            ...
            for TMP2 in ["5000", "10000", "15000", "20000"]:
                ...
                configs_input = {'contact-map': (f"/Users/andreraf/UiO Dropbox/Andrea Raffo/"
                ...
                configs_thresholds = {'glob_pers_type': 'constant',
                                      'glob_pers_min': 0.025,
                ...
                configs_output = {'output_folder': f"/Users/andreraf/UiO Dropbox/Andrea Raffo/"
                ...
                # Data loading:
                c, chr_starts, chr_ends, bp_lengths = others.cmap_loading(configs_input['contact-map'],
                ...
                for this_chr_idx, this_chr in c_pairs:
                    ...
                    if all(param is not None for param in [RoI, configs_output['output_folder']]):
                        ...
                        LT_Iproc, UT_Iproc, _ = stripepy.step_1(I, configs_input['genomic_belt'],
                                                                configs_input['resolution'])
                        Iproc_RoI = None
                    ...
                    if all(param is not None for param in [Iproc_RoI, RoI, configs_output['output_folder']]):
                        ...
                        pseudo_distributions, candidate_stripes = stripepy.step_2(LT_Iproc,
                                                                                  ...
                                                                                  configs_thresholds['glob_pers_min'],
                                                                                  hf[
                                                                                      f"{this_chr}/global-pseudo-distributions/"])
