...
.. code-block:: bash
  ...
  pip install 'stripepy-hic[all] @ git+https://github.com/paulsengroup/StripePy.git@v1.2.1'
...
.. code-block:: bash
  ...
  pip install 'stripepy-hic[all] @ https://pypi.python.org/packages/source/s/stripepy_hic/stripepy_hic-1.2.1.tar.gz'
...
.. code-block:: console
  ...
  user@dev:/tmp$ docker run ghcr.io/paulsengroup/stripepy:1.2.1 --help

  # Using Singularity/Apptainer
  user@dev:/tmp$ singularity run ghcr.io/paulsengroup/stripepy:1.2.1 --help
